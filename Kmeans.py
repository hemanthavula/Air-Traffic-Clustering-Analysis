...
df = pd.read_csv(r"C:\Users\heman\Downloads\Dataset (7)\Dataset\AirTraffic_Passenger_Statistics.csv")

# Credentials to connect to Database
user = 'root' # user name
pw = quote('Hemanth@17') # password
db = 'udb' # database
...
# Operating Airline, Passenger Count and Flights held by each airline.
